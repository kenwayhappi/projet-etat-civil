...
<body>
    <div class="document">
        ...
        <div class="content">
            ...
            <div class="info-grid">
                <div class="info-item">
                    <div class="info-label">Nom du défunt</div>
                    <div class="info-value">{{ $act->details['deceased_name'] ?? 'Non renseigné' }}</div>
                </div>

                <div class="info-item">
                    <div class="info-label">Date de décès</div>
                    <div class="info-value">{{ isset($act->details['death_date']) ? \Carbon\Carbon::parse($act->details['death_date'])->format('d/m/Y') : 'Non renseignée' }}</div>
                </div>

                <div class="info-item full-width">
                    <div class="info-label">Lieu de décès</div>
                    <div class="info-value">{{ $act->details['death_place'] ?? 'Non renseigné' }}</div>
                </div>
            </div>
